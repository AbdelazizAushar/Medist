...
Route::middleware('auth:sanctum')->group(function () {
    ...
    Route::delete('medicine/{medicine}', [MedicineController::class, 'destroy']); //delete medicine
  ...
  /**/  Route::get('companies/{company}', [CompanyController::class, 'show']); // get specific company
    ...
    Route::get('order/{order}/check', [OrderController::class, 'checkPossibility']); // check possibility
});
